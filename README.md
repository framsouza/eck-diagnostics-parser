...
#### Building the binary
```
- git clone git@github.com:framsouza/eck-diagnostics-parser.git
- cd eck-diagnostics-parser/ && go build -o eck-diagnostics-parser ./cmd
```

It will generate a `./eck-diagnostics-parser` command, you put it in the PATH

#### Without building
```
- git clone git@github.com:framsouza/eck-diagnostics-parser.git
- cd eck-diagnostics-parser/ &&  go run cmd/main.go -zipfile  <pathtotheeckdiagnostic.zip>
```
...
indexer-es-data-hot-0               default             Running             16Gi                 16Gi                1                    1                   ip-10-52-1-46.eu-central-1.compute.internal 
indexer-es-data-hot-1               default             Running             16Gi                 16Gi                1                    1                   ip-10-52-2-170.eu-central-1.compute.internal
indexer-es-data-hot-2               default             Running             16Gi                 16Gi                1                    1                   ip-10-52-3-15.eu-central-1.compute.internal 
indexer-es-data-warm-0              default             Running             6Gi                  6Gi                 1                    1                   ip-10-52-3-15.eu-central-1.compute.internal 
indexer-es-data-warm-1              default             Running             6Gi                  6Gi                 1                    1                   ip-10-52-1-46.eu-central-1.compute.internal 
indexer-es-data-warm-2              default             Running             6Gi                  6Gi                 1                    1                   ip-10-52-2-170.eu-central-1.compute.internal
indexer-es-master-node-0            default             Running             2Gi                  2Gi                 Not set              Not set             ip-10-52-2-170.eu-central-1.compute.internal
indexer-es-master-node-1            default             Running             2Gi                  2Gi                 Not set              Not set             ip-10-52-3-15.eu-central-1.compute.internal 
indexer-es-master-node-2            default             Running             2Gi                  2Gi                 Not set              Not set             ip-10-52-1-46.eu-central-1.compute.internal 
indexer-kb-556cdcbdf-hrxh4          default             Running             1Gi                  1Gi                 Not set              Not set             ip-10-52-1-46.eu-central-1.compute.internal 
...
indexer                       green               7.16.3              Ready               9                   default

KB NAME                       STATUS              VERSION             PHASE                NODES               NAMESPACE           
indexer                       green               7.16.3              Established          1                   default

STATEFULSET NAME                          REPLICAS            NAMESPACE           HEAP SIZE              
indexer-es-data-hot                       3                   default             -Xms8g -Xmx8g          
indexer-es-data-warm                      3                   default             -Xms4g -Xmx4g          
indexer-es-master-node                    3                   default             

STATEFULSET NAME                    REPLICAS            NAMESPACE               HEAP SIZE           
elastic-operator                    1                   elastic-system

DEPLOYMENT NAME                    REPLICAS            NAMESPACE           
indexer-kb                         1                   default

PVC NAME                                             STATUS              CAPACITY            VOLUME NAME                                       SC NAME             ACCESS MODE              
elasticsearch-data-indexer-es-data-hot-0             Bound               613Gi               pvc-455f7a2d-fcc4-44ec-8750-11d09cf95e7b          gp2                 [ReadWriteOnce]
elasticsearch-data-indexer-es-data-hot-1             Bound               613Gi               pvc-2b3e1470-9ea0-4110-b2b9-bab8d31ed61f          gp2                 [ReadWriteOnce]
elasticsearch-data-indexer-es-data-hot-2             Bound               613Gi               pvc-355786de-07a4-4d28-9988-54698460933c          gp2                 [ReadWriteOnce]
elasticsearch-data-indexer-es-data-warm-0            Bound               1613Gi              pvc-496dc5dc-3584-456b-885c-960b45236193          gp2                 [ReadWriteOnce]
elasticsearch-data-indexer-es-data-warm-1            Bound               1613Gi              pvc-6147efb9-e5b6-4f47-9f7c-cfec69679c4c          gp2                 [ReadWriteOnce]
elasticsearch-data-indexer-es-data-warm-2            Bound               1613Gi              pvc-3a5fc7c6-d522-4aae-b2f2-217884294507          gp2                 [ReadWriteOnce]
elasticsearch-data-indexer-es-master-node-0          Bound               13Gi                pvc-237493f9-252e-4ad1-b3e2-4d78ac930338          gp2                 [ReadWriteOnce]
elasticsearch-data-indexer-es-master-node-1          Bound               13Gi                pvc-b2fc54a3-4dcf-4b18-a9b0-7e825533e8d3          gp2                 [ReadWriteOnce]
elasticsearch-data-indexer-es-master-node-2          Bound               13Gi                pvc-74179549-8367-412b-bb32-3b0f632d60ab          gp2                 [ReadWriteOnce]

SERVICE NAME                    TYPE                  NAMESPACE           ENDPOINTS           
indexer-es-data-hot             ClusterIP             default             10.52.1.19, 10.52.2.147, 10.52.3.245, 
indexer-es-data-warm            ClusterIP             default             10.52.1.81, 10.52.2.231, 10.52.3.240, 
indexer-es-http                 LoadBalancer          default             10.52.1.155, 10.52.1.19, 10.52.1.81, 10.52.2.147, 10.52.2.218, 10.52.2.231, 10.52.3.240, 10.52.3.245, 10.52.3.95, 
indexer-es-master-node          ClusterIP             default             10.52.1.155, 10.52.2.218, 10.52.3.95, 
indexer-es-transport            ClusterIP             default             10.52.1.155, 10.52.1.19, 10.52.1.81, 10.52.2.147, 10.52.2.218, 10.52.2.231, 10.52.3.240, 10.52.3.245, 10.52.3.95, 
indexer-kb-http                 LoadBalancer          default             10.52.1.120, 
